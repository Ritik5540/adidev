            ...
            <div class="row">
                        ...
                        <div class="dashboard_sidebar_area">
                            ...
                            <div class="dashboard_sidebar_menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="dashboard_return_request.php">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <li>
                                        <a class="active" href="dashboard_profile.php">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="col-lg-9 wow fadeInRight">
                    <div class="dashboard_content mt_100">
                        <h3 class="dashboard_title">Add New Address <a class="common_btn cancel_edit"
                                href="dashboard_profile.php">cancel</a></h3>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="single_input">
                                            <label>Name</label>
                                            <input type="text" placeholder="Rajan Singh">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="single_input">
                                    ...
                                    <div class="col-md-12">
                                        <div class="single_input">
                                            <label>Address</label>
                                            <textarea rows="6"
                                                placeholder="IITPL NimbusHyde Park, Hyde Park, Sector 78, Noida, Uttar Pradesh 201301"></textarea>
                                        </div>
                                        <button type="submit" class="common_btn">Save Address <i
