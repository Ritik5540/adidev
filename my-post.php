<?php include "header.php"; ?>
    ...
    <section class="dashboard mb_100">
      ...
      <!-- Right Content Area -->
      <div class="col-md-9">
        <section id="panel-post" role="tabpanel">
          <h1 class="h4 fw-bold mb-4 mt-4">My Post</h1>
          <div class="bg-white p-4 rounded shadow-sm">
            <form action="#">
              <div class="row g-3">
                ...
                <div class="col-12">
                  <input type="text" class="form-control" placeholder="Task 2">
                </div>
                <div class="col-12 mb-3">
                  <input type="text" class="form-control" placeholder="Task 3">
                </div>
                <div class="col-12">
