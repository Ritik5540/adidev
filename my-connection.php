        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 wow fadeInRight">
                    <!-- Main Content (right) -->
      <div class="col-md-9">
        <section id="panel-connection" role="tabpanel">
          <h1 class="h4 fw-bold mb-4 mt-5">My Connection</h1>
          <div class="table-responsive">
            <table class="table table-hover table-bordered align-middle mb-0">
              ...
              <tbody>
                <tr><th scope="row">1</th><td>192.168.1.1</td><td>5 Jun 2025</td></tr>
                <tr><th scope="row">2</th><td>192.168.1.2</td><td>9 Jun 2025</td></tr>
                <tr><th scope="row">3</th><td>132.168.1.2</td><td>10 Jun 2025</td></tr>
                <tr><th scope="row">4</th><td>194.168.1.2</td><td>12 Jun 2025</td></tr>
              </tbody>
            </table>
          </div>
        </div>
