                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-xl-6 col-md-6">
                                        <div class="single_input">
                                            ...
                                            <input type="text" placeholder="Rajan">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-6 col-md-6">
                                        <div class="single_input">
                                            <label>last name</label>
                                            <input type="text" placeholder="Dube">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-6 col-md-6">
                                        <div class="single_input">
...
">
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-md-12">
                                        <div class="single_input">
                                            <label>Address</label>
                                            <textarea rows="5" placeholder="Write your address"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-12 col-md-12">
                                        <div class="single_input">
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-md-12">
                                        <div class="become_vendor_form_chek">
                                            ...
                                            <button class="common_btn">Sign Up <i
