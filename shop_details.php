                    ...
                    <div class="row">
                                        ...
                                        <div class="row details_slider_thumb">
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="assets/images/product_1-1.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="assets/images/product_1-2.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="assets/images/product_1-3.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="assets/images/product_1-4.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="assets/images/product_1-6.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6 wow fadeInUp">
                            <div class="shop_details_text">
                                <p class="category">Computers & Tablets</p>
                                <h2 class="details_title">Full Sleeve Hoodie Jacket</h2>
                                ...
                                <h3 class="price">$65.00 <del>$70.00</del></h3>
                                <p class="short_description">Auctor urna nunc id cursus. Scelerisque purus semper eget
                                    duis at
                                ...
                                <ul class="details_list_btn">
                                    ...
                                    <li>
                                        <a href="#"><i class="fal fa-question-circle"></i> Ask a question</a>
                                    </li>
                                </ul>
                        ...
                        C36.924,469.341,42.667,463.598,42.667,456.541z" />
                                ...
                                <div class="col-xxl-12 col-md">
                                    <div class="shop_details_sidebar_store">
                                        ...
                                        <a class="go_store" href="vendor_details.php">Go To Store</a>
                                        <a class="chat" href="#">
            ...
            <div class="row mt_25 flash_sell_2_slider">
                ...
                <div class="col-xl-1-5">
                    <div class="product_item_2 product_item">
                        ...
                        <div class="product_text">
                            <a class="title" href="shop_details.php">Denim casual blazer for men</a>
                ...
                <div class="col-xl-1-5">
                    <div class="product_item_2 product_item">
                        ...
                        <div class="product_text">
                            <a class="title" href="shop_details.php">tops pant beautiful dress</a>
