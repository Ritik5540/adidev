...
<!--=========================
    ...
    <section class="dashboard mb_100">
      ...
      <div class="col-md-9">
        <h1 class="h3 fw-bold mb-4 mt-5">Category & Planting</h1>
        <section id="panel-product" role="tabpanel">
          <h2 class="h5 fw-bold mb-3">Product</h2>
          <div class="table-responsive">
            <table class="table table-hover align-middle text-nowrap">
              ...
              <tbody>
                <tr>
                  <th scope="row">Turn Mower</th>
                  <td>$150.00</td>
                  <td><input type="text" value="$20.00" class="form-control" /></td>
                  <td><button class="btn btn-success px-3">Submit</button></td>
                  <td class="final-price">$130.00</td>
                </tr>
                <tr>
                  <th scope="row">Hands Gloves</th>
                  <td>$70.50</td>
                  <td><input type="text" value="$20.50" class="form-control" /></td>
                  <td><button class="btn btn-success px-3">Submit</button></td>
                  <td class="final-price">$50.00</td>
                </tr>
                <tr>
                  <th scope="row">Custom Pot</th>
                  <td>$50.00</td>
                  <td><input type="text" value="$10.00" class="form-control" /></td>
                  <td><button class="btn btn-success px-3">Submit</button></td>
                  <td class="final-price">$40.00</td>
                </tr>
                <tr>
                  <th scope="row">Bag</th>
                  <td>$160.00</td>
                  <td><input type="text" value="$20.00" class="form-control" /></td>
                  <td><button class="btn btn-success px-3">Submit</button></td>
                  <td class="final-price">$140.00</td>
                </tr>
              </tbody>
            </table>
          </div>
