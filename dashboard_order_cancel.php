            ...
            <div class="row">
                ...
                <div class="col-lg-9 wow fadeInRight">
                    <div class="dashboard_content mt_100">
                        <h3 class="dashboard_title">Order Details <a class="back_btn common_btn"
                                href="dashboard_order.php">Go Back</a></h3>
                        <div class="dashboard_order_invoice_area">
                            <div class="dashboard_order_invoice">
                                ...
                                <div class="dashboard_invoice_footer">
                                    <div class="single_input mb_70">
                                        <label>Note</label>
                                        <textarea rows="3" placeholder="Cancellation Note"></textarea>
                                    </div>
                                    <a class="common_btn order_cancel_btn" href="#">Cancel Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
