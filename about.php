...
<!--=========================
                ...
                <div class="col-12">
                    <ul>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand1.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand2.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand3.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                        ...
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand4.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand5.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand6.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand7.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand8.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand9.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
                                <img src="assets/images/brand10.png" alt="Brand" class="img-fluid">
                            </a>
                        </li>
                        <li class="wow fadeInUp">
                            <a href="shop.php">
            ...
            <div class="row">
                <div class="col-12 wow fadeInUp">
                    <div class="about_video_area">
                        <img src="assets/images/about_video_bg.jpg" alt="about video" class="img-fluid w-100">
                        <div class="overlay">
    ...
    <section class="blog_2 pt_95 mb_100">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-sm-9">
                    <div class="section_heading_2 section_heading">
            ...
            <div class="row mt_15">
                <div class="col-lg-4 col-xxl-3 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <a href="blog.php" class="blog_img">
                            <img src="assets/images/blog_img_1.png" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="blog_text">
                            <ul class="top">
                                <li>
                                    <span>
                                        <img src="assets/images/user_icon_black.svg" alt="user" class="img-fluid w-100">
                                    </span>
                                    Adnan Alvi
                                </li>
                                <li>
                            ...
                            <a class="title" href="blog.php">How to Plop Hair for Bouncy, Beautiful Curls</a>
                            <ul class="bottom">
                                <li><a href="blog.php">read more <i class="fas fa-long-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-xxl-3 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <a href="blog.php" class="blog_img">
                            <img src="assets/images/blog_img_2.png" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="blog_text">
                            <ul class="top">
                                <li>
                            ...
                            <a class="title" href="blog.php">Fast fashion: How clothes are linked to climate
                                change</a>
                            <ul class="bottom">
                                <li><a href="blog.php">read more <i class="fas fa-long-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-xxl-3 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <a href="blog.php" class="blog_img">
                            <img src="assets/images/blog_img_3.png" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="blog_text">
                            <ul class="top">
                                <li>
                            ...
                            <a class="title" href="blog.php">Which foundation formula is right for your
                                skin?</a>
                            <ul class="bottom">
                                <li><a href="blog.php">read more <i class="fas fa-long-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-xxl-3 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <a href="blog.php" class="blog_img">
                            <img src="assets/images/blog_img_4.png" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="blog_text">
                            <ul class="top">
                                <li>
                            ...
                            <a class="title" href="blog.php">How To Choose The Right Sofa for your home</a>
                            <ul class="bottom">
                                <li><a href="blog.php">read more <i class="fas fa-long-arrow-right"></i></a>
                                <li><span><i class="far fa-comment-dots"></i> 15 Comments</span></li>
                            </ul>
